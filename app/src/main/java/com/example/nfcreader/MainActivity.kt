    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            if (nfcAdapter == null) {
                ...
                myDialog.show()
                binding.txtviewshopid.setText("THIS DEVICE DOESN'T SUPPORT NFC. PLEASE TRY WITH ANOTHER DEVICE!")
                ...
                binding.txtviewshopid.setText("NFC IS NOT ENABLED. PLEASE ENABLE NFC IN SETTINGS->NFC")
                binding.txtviewmachineid.visibility = View.INVISIBLE
        ...
        if (NfcAdapter.ACTION_NDEF_DISCOVERED == action) {
            ...
            with(parcelables) {
                try {
                    ...
                    binding.txtviewshopid.setText("SHOP ID: " + shopid)

                    ndefRecord_0 = inNdefRecords[1]
                    inMessage = String(ndefRecord_0.payload)
                    machineid = inMessage.drop(3);
                    binding.txtviewmachineid.setText("MACHINE ID: " + machineid)
                    ...
                    if (!binding.txtuserid.text.toString().equals("")) {
                        if (NfcAdapter.ACTION_TECH_DISCOVERED == intent.action
                            ...
                            if (ndef.isWritable) {
                                ...
                                binding.txtviewuserid.setText("USER ID: " + binding.txtuserid.text.toString());
                                Toast.makeText(
                                    applicationContext,
                                    "Successfully Wroted!",
                                    Toast.LENGTH_SHORT
...
//
                        ...
                        try {
                            ...
                            binding.txtviewuserid.setText("USER ID: " + inMessage.drop(3))
                        } catch (ex: Exception) {
                            Toast.makeText(
                                applicationContext,
                                "User ID not writted!",
